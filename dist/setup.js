...
function setupGanache() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const server = ganache_1.default.server({ seed: "asd123", account_keys_path: "src/accounts.json" });
        return yield new Promise((resolve) => {
            server.listen(8545, () => {
                console.log("Ganache running at http://localhost:8545");
                resolve(new web3_1.default(server.provider));
            });
        });
    });
}
